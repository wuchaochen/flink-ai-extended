...
class AIFlowHandler(EventHandler):
    """
    AirFlow's EventHandler interface implemented according to the control side semantics.
    """
    ...
    def parse_configs(config_str: str):
        ...
        for config in config_json:
            met_config = ConditionConfig(event_key=config['event_key'],
                                         ...
                                         condition_type=ConditionType(config['condition']),
            ...
            if met_config.condition == ConditionType.SUFFICIENT:
                ...
                for event in events:
                    ...
                    if met_config.life == EventLife.ONCE:
                        if met_config.value_condition == ValueCondition.EQUALS:
