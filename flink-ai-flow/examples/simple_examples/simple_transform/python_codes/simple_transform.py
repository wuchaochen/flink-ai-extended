...
def run_project(project_root_path):
    ...
    cmd_job_config = af.JobConfig(platform=LocalPlatform.platform(), job_type=CMDEngine().engine())
    ...
    python_job_config = af.JobConfig(platform=LocalPlatform.platform(), job_type=PythonEngine.engine())
